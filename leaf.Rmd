...
# plot_report_vector(
#     report, x_var, y_cols, x_lab = x_lab,
#     y_lab = 'Lag duration of leaf cohort (oCd)', unique = TRUE)
...
<div class="fig-output">
```{r leaf-cohort-no, fig.asp = 1, fig.cap="The number of leaf cohort with certain status including initialised, appeared, expanded, green, dead"}
y_cols <- c("Wheat.Leaf.InitialisedCohortNo",
