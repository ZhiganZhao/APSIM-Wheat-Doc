...
xpath <- '//RUEModel/WeightedTemperatureFunction/Name[text()="FT"]'
...
xpath <- '//RUEModel/LinearInterpolationFunction/Name[text()="FN"]'
...
xpath <- '//RUEModel/LinearInterpolationFunction/Name[text()="FW"]'
