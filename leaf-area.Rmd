...
xpath <- 'Wheat.Leaf.CohortParameters.MaxArea.AgeFactor'
...
xpath <- 'Wheat.Leaf.CohortParameters.CellDivisionStress.WaterStressEffect'
...
xpath <- 'Wheat.Leaf.CohortParameters.CellDivisionStress.NitrogenStressEffect'
...
xpath <- paste0('Wheat.Leaf.CohortParameters.ExpansionStress.', 
