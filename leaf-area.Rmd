...
plot_xypair(g_pmf, path, x_lab = 'Growthing stage', y_lab = 'Multiplier of maximum leaf area')
```
</div>
...
plot_report_rank(g_report, y_cols, y_lab = 'Maximum leaf area (mm2)')
```
</div>
...
'Wheat.Leaf.LAIDead',
'Wheat.Leaf.LAITotal')
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, y_lab = 'Leaf area index')
...
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, y_lab = 'Coverage',
...
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, y_lab = 'Specific leaf area (mm2/g)')
