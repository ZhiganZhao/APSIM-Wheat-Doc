...
plot_xypair(pmf, path, x_lab = 'Growthing stage', y_lab = 'Multiplier of maximum leaf area')
```
</div>
...
plot_xypair(pmf, path, x_lab = 'Ratio of water supply and demand', 
...
plot_xypair(pmf, path, x_lab = 'Ratio of functional nitrogen', 
...
plot_xypair(pmf, path, x_lab = 'Values for stress factors', 
