...
plot_report_rank(report, y_cols, y_lab = 'Maximum leaf area (mm2)')
```
</div>
...
plot_report(report, x_var2, y_cols, 
...
xpath <- '//LeafCohortParameters/MinimumFunction/Name[text()="CellDivisionStress"]/following-sibling::LinearInterpolationFunction/Name[text()="WaterStressEffect"]'
plot_xypair(pmf, xpath, x_lab = 'Ratio of water supply and demand', 
...
xpath <- '//LeafCohortParameters/MinimumFunction/Name[text()="CellDivisionStress"]/following-sibling::LinearInterpolationFunction/Name[text()="NitrogenStressEffect"]'
plot_xypair(pmf, xpath, x_lab = 'Ratio of functional nitrogen', 
...
plot_report_vector(report, x_var, y_cols, 
    y_lab = 'Maximum leaf area (mm2)', rank = TRUE)
...
TT <- seq(0, 100, by = 1)
MaxArea <- 2600
LeafSizeShape <- as.numeric(get_fixed_value(pmf, '//LeafCohortParameters/Constant/Name[text()="LeafSizeShapeParameter"]'))
GrowthDuration <- 100
...
xpath <- c('//LeafCohortParameters/MinimumFunction/Name[text()="ExpansionStress"]/following-sibling::LinearInterpolationFunction/Name[text()="TemperatureEffect"]',
            '//LeafCohortParameters/MinimumFunction/Name[text()="ExpansionStress"]/following-sibling::LinearInterpolationFunction/Name[text()="WaterStressEffect"]',
            '//LeafCohortParameters/MinimumFunction/Name[text()="ExpansionStress"]/following-sibling::LinearInterpolationFunction/Name[text()="NitrogenStressEffect"]')
plot_xypair(pmf, xpath, x_lab = 'Values for stress factors', 
            y_lab = 'Multiplier of leaf expansion', label = c('Temperature', 'Water', 'Nitrogen'))
```
</div>
...
### Leaf area index and ground coverage
...
The extinction coefficient for dead leaf ($k_{d}$) is defined as `r get_xml_value(pmf, '//Leaf/KDead')`. The extinction coefficient for green leaf ($k_{g}$) is calculated by parameter `ExtinctionCoeff` with default value `r get_fixed_value(pmf, '//Leaf/Constant/Name[text()="ExtinctionCoeff"]')`.  
...
plot_report(report, x_var2, y_cols, 
            y_lab = 'Specific leaf area (mm2/g)', ncol = 2, 
            y_labels = c('Min', 'Max'))
```
</div>
