...
The base phyllochron is a genotypic parameter with default value `r get_fixed_value(pmf, '//Name[text()="BasePhyllochron"]')`, but is chagned for most of cultivars. Based on [@JamiesonPredictionleafappearance1995], leaf appearance could be described by a base phyllochron determined between leaves 3 and 7 and a phyllochron that was 70% of base phyllochron for leaves < 3 and 140% of base phyllochroen for leaves > 7 (Fig. \@ref(fig:str-phyllochron-age)). The phyllochron also is adjusted by photoperiod [reference required] through increasing pholochron in the shorter day length (Fig. \@ref(fig:str-phyllochron-ppd)).
...
plot_report(report, x_var2, y_cols, x_lab = x_lab, y_lab = 'Final node number in main stem')
...
xpath <- paste0('//MultiplyFunction/Name[text()="BranchingRate"]',
                '/following-sibling::MinimumFunction', 
                '/Name[text()="StressFactors"]',
                '/following-sibling::LinearInterpolationFunction', 
                '/Name[text()="',
...
xpath <- '//PhaseLookup/Name[text()="MortalityPerDegDay"]'
xpath <- paste0('//PhaseLookup/Name[text()="BranchMortality"]',
                '/following-sibling::PhaseLookupValue', 
                '/Name[text()="MortalityPhase"]',
                '/following-sibling::MultiplyFunction', 
                '/Name[text()="Mortality"]',
                '/following-sibling::LinearInterpolationFunction', 
                '/Name[text()="MortalityPerDegDay"]')
...
Figure \@ref(fig:str-tiller-growth-rate-factor) shows the mean tiller growth rate and the three factors to calculate it in the test simulation.
...
plot_report(report, x_var, y_cols, x_lab = x_lab, y_lab = 'Mortality of branching', ncol = 3)
...
<div class="fig-output">
```{r str-polulation, fig.asp = 0.5, fig.cap='Plant population.'}
y_cols <- c('Wheat.Structure.MainStemPopn')
plot_report(report, x_var2, y_cols, x_lab = 'Growth stage', y_lab = 'Plant population', ncol = 3)
...
plot_report(report, x_var, y_cols, x_lab = x_lab, y_lab = 'Stem population', ncol = 3)
...
```{block, type="rmdnote"}
Height is not used in other parts of wheat model.
```
...
xpath <- '//HeightFunction/LinearInterpolationFunction/Name[text()="PotentialHeight"]'
...
xpath <- '//HeightFunction/LinearInterpolationFunction/Name[text()="WaterStress"]'
plot_xypair(pmf, xpath, x_lab = 'water-supply-demand-ratio', y_lab = 'Potential canopy height (mm)')
```
</div>
