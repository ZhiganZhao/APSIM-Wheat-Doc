...
plot_xypair(pmf, path, x_lab = 'Appeared cohorted number', y_lab = 'Mulitiplier of base phyllochron') +
...
plot_xypair(pmf, path, x_lab = 'Daily photoperiod (h)', y_lab = 'Mulitiplier of base phyllochron') +
...
plot_xypair(pmf, path, x_lab = 'Number of appeared cohorts', y_lab = 'Branching rate')
...
plot_xypair(pmf, path, x_lab = 'Moving mean tiller growth rate', y_lab = 'Branch motality')
```
</div>
...
plot_xypair(pmf, path, x_lab = 'Stage', y_lab = 'Potential canopy height (mm)')
```
</div>
...
plot_xypair(pmf, path, x_lab = 'water-supply-demand-ratio', y_lab = 'Multiplier of water stress on canopy height')
```
</div>
