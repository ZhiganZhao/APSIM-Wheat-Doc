...
$F_{spike, structure}$ is the structura fraction of `Spike` with default value `e get_fixed_value(g_pmf, 'Wheat.Spike.StructuralFraction')` (Fig. \@ref(fig:spike-stucture-fraction)). $C_{spike,efficiency}$ is the conversion efficiency of `Spike`, i.e. the efficiency of alloction biomass converted into carbon (growth respiration). $C_{efficiency}$ has the default value `r get_fixed_value(g_pmf, 'Wheat.Spike.DMConversionEfficiency')` and is counted befor allocation. 
