...
<div class="fig-input">
```{r spike-stucture-fraction, fig.asp = 0.5, fig.cap='Growth duration of spike development'}
y_cols <- c('Wheat.Spike.StructuralFraction')
report %>% 
    filter(Wheat.Phenology.Stage > 5) %>% 
    plot_report(x_var2, y_cols, x_lab = x_lab,
            y_lab = 'Structure fraction')
```
</div>


<div class="fig-input">
```{r spike-conversion-efficiency, fig.asp = 0.5, fig.cap='Conversion efficiency of spike'}
y_cols <- c('Wheat.Spike.DMConversionEfficiency')
report %>% 
    filter(Wheat.Phenology.Stage > 5) %>% 
    plot_report(x_var2, y_cols, x_lab = x_lab,
            y_lab = 'Conversion efficiency of spike')
```
</div>
