...
g_report %>% 
    select(c('Wheat.Phenology.Stage', y_cols)) %>% 
    filter(Wheat.Phenology.Stage > 6) %>% 
    summarise(a = sum(Wheat.AllocatedN),
              b = sum(Wheat.Arbitrator.N.TotalUptakeSupply))
...
<div class="fig-output">
```{r nitrogen-structural, fig.cap='Structural nitrogen'}
...
<div class="fig-output">
```{r nitrogen-metabolic, fig.cap='Metabolic nitrogen'}
...
<div class="fig-output">
```{r nitrogen-storage, fig.cap='Storage nitrogen'}
