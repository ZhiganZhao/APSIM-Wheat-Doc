...
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, 
            y_lab = 'Structural and metabolic demand (g/g)', y_labels = g_organs,
            ncol = 5, type = 'area')
```
</div>
...
<div class="fig-input">
```{r biomass-maintenance-respiration-beta, fig.asp = 0.5, fig.cap='The response of maintenance respiration on daily average temperature, which is reproduced from parameter values in Table \\@ref(tab:biomass-wefuncton).'}
avgt <- seq(0, 40)
res_fun <- function(df) {
