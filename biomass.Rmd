...
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, 
            y_lab = 'Fixation (g/m2/d)', y_labels = g_organs,
            ncol = 5)
```
</div>
...
plot_report(g_report, g_xvar, y_cols, x_lab = g_xlab, 
            y_lab = 'Retranslocation (g/m2/d)', y_labels = g_organs,
            ncol = 5)
...
plot_report(g_report, g_xvar2, y_cols, x_lab = g_xlab2, 
            y_lab = 'Reallocation (g/m2/d)', y_labels = g_organs,
            ncol = 5)
```
</div>
...
The daily biomass supply (Fig. \@ref(fig:biomass-supply-total)) are consumed as growth respiration before partitioning into `Live` pool in each organ, and consumed as daily maintenance respiration from `Live` pool in each organ (Fig. \@ref(fig:biomass-destiny)).
