...
y_cols <- c(sprintf('Wheat.Root.%sN', g_demand), 'Wheat.Root.N')
...
y_cols <- c(sprintf('Wheat.Root.Live.%sN', g_demand), 'Wheat.Root.Live.N')
...
y_cols <- c(sprintf('Wheat.Root.Dead.%sN', g_demand), 'Wheat.Root.Dead.N')
...
y_cols <- c(sprintf('Wheat.Root.Live.%sNConc', g_demand), 'Wheat.Root.Live.NConc')

plot_report(g_report, g_xvar2, y_cols, x_lab = g_xlab2, 
            y_lab = expression(atop('Nitrogen concentration',
                                    '(g N '~g^-1~' biomass )')),
            y_labels = c(g_demand, 'Live'),
            ncol = 4)
...
y_cols <- c(sprintf('Wheat.Root.Dead.%sNConc', g_demand), 'Wheat.Root.Dead.NConc')

plot_report(g_report, g_xvar2, y_cols, x_lab = g_xlab2, 
            y_lab = expression(atop('Nitrogen concentration',
                                    '(g N '~g^-1~' biomass )')),
            y_labels = c(g_demand, 'Dead'),
            ncol = 4)
